...
// Replace the entire activeTab === 'gif' block
const startStr = "{activeTab === 'gif' && (";
const endStr = "                    {/* INTERACTIVE OUTREACH CHANNEL PLAYBOOK */}";
...
content = parts[0] + "{activeTab === 'gif' && (" + newGifUI + "\n              )}\n\n" + endStr + subParts[1];
